...
public class Put_tc1 {
	...
	public static void orchestrator() throws IOException
	{
		...
		for(int i=0; i<5; i++)
		{
			response_statuscode=common_method_put_api.responsestatuscode_extractor(baseURI, resource, requestbody);
		...
		common_method_utilitise.EvidenceFileCreator("Put_tc1", requestbody, response_body);
